...
namespace Arquivos.Views
{
    public class AnimalView
    {
        ...
        public void Init()
        {
            ...
            Console.WriteLine("2 - listar animail");
            Console.WriteLine("3 - Exportar animail para txt");
            Console.WriteLine("4 - Importar animail");
            Console.WriteLine("0 - Pesquisar animal");
